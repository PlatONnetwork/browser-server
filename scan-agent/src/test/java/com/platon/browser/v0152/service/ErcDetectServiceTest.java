...
public class ErcDetectServiceTest extends AgentTestBase {
    ...
    private String inputdata = "0x01ffc9a701ffc9a700000000000000000000000000000000000000000000000000000000";
    ...
    public void setup() throws IOException {
        ...
        // 测试超时异常
        //when(request.send()).thenThrow(new SocketTimeoutException());
        // 测试业务异常
        when(request.send()).thenThrow(new IOException());
    }

    @Test
    public void detectInputData() {
        boolean res = ercDetectService.isSupportErc721Enumerable(contractAddress);
    }
