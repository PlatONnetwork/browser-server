 ...
 * 但是发现这样不奏效，而是需要注释掉AgentApplication.class的@Configuration，@SpringBootApplication, @EnableScheduling这三个注解才行。
 * >>>>!!!在测试完成后，需要把AgentApplication.class的@Configuration，@SpringBootApplication, @EnableScheduling这三个这两个注解打开!!!<<<
 *
 */
@Slf4j
@EnableRetry
