...
//        			proposal.setNays(proposal.getNays() - 1);
//        		} else if(vote.getOption() == Integer.valueOf(OptionEnum.SUPPORT.getCode())) {
//        			proposal.setYeas(proposal.getYeas() - 1);
//        		} else if(vote.getOption() == Integer.valueOf(OptionEnum.ABSTENTION.getCode())) {
//        			proposal.setAbstentions(proposal.getAbstentions() - 1);
//        		} 
