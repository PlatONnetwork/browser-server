...
public class CandidateContract extends PlatOnContract {
    ...
    public RemoteCall<String> GetBatchCandidateDetail(List<String> nodeIds) {
        final Function function = new Function(FUNC_GETBATCHCANDIDATEDETAIL,
                Arrays.<Type>asList(new org.web3j.abi.datatypes.DynamicArray<Utf8String>(
                        org.web3j.abi.Utils.typeMap(nodeIds, Utf8String.class))),
                Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }
    ...
    public static RemoteCall<CandidateContract> deploy(Web3j web3j, Credentials credentials, String contractBinary, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(CandidateContract.class, web3j, credentials, contractGasProvider, contractBinary, ABI, "");
    }

    @Deprecated
    public static RemoteCall<CandidateContract> deploy(Web3j web3j, Credentials credentials, String contractBinary, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(CandidateContract.class, web3j, credentials, gasPrice, gasLimit, contractBinary, ABI, "");
    }

    public static RemoteCall<CandidateContract> deploy(Web3j web3j, TransactionManager transactionManager, String contractBinary, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(CandidateContract.class, web3j, transactionManager, contractGasProvider, contractBinary, ABI, "");
    }

    @Deprecated
    public static RemoteCall<CandidateContract> deploy(Web3j web3j, TransactionManager transactionManager, String contractBinary, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(CandidateContract.class, web3j, transactionManager, gasPrice, gasLimit, contractBinary, ABI, "");
    }

    @Deprecated
    public static CandidateContract load(String contractBinary, String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new CandidateContract(contractBinary, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static CandidateContract load(String contractBinary, String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new CandidateContract(contractBinary, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static CandidateContract load(String contractBinary, String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new CandidateContract(contractBinary, contractAddress, web3j, credentials, contractGasProvider);
    }

    public static CandidateContract load(String contractBinary, String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new CandidateContract(contractBinary, contractAddress, web3j, transactionManager, contractGasProvider);
    }
