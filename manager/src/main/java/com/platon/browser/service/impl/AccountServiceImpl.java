...
public class AccountServiceImpl implements AccountService {
    ...
    public AddressDetail getAddressDetail(AddressDetailReq req) {
        ...
        try {
            ...
            returnData.setBalance(BigDecimal.valueOf(v.doubleValue()).toString());
        } catch (IOException e) {
        ...
        transactions.forEach(initData -> {
            ...
            bean.setValue(BigDecimal.valueOf(v.doubleValue()).toString());
            v = Convert.fromWei(initData.getActualTxCost(), Convert.Unit.ETHER).setScale(18, RoundingMode.DOWN);
            bean.setActualTxCost(BigDecimal.valueOf(v.doubleValue()).toString());
            data.add(bean);
        });
