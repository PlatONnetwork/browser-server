...
public abstract class ESRepository {
     ...
     * @throws IOException
     */
    public <T> List<T> search(Map<String,Object> filter, Class<T> clazz, int pageNo, int pageSize) throws IOException {
        if(pageNo<=0) throw new RuntimeException("pageNo必须大于等于1");
