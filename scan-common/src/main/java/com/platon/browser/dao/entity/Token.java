...
public class Token {
    ...
    public Long getCreatedBlockNumber() {
        return createdBlockNumber;
    }

    public void setCreatedBlockNumber(Long createdBlockNumber) {
    ...
    public enum Column {
        ...
        createdBlockNumber("created_block_number", "createdBlockNumber", "BIGINT", false);
