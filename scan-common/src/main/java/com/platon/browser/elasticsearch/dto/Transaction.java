...
public class Transaction {
    ...
    public enum TypeEnum {
        ...
        PROPOSAL_PARAMETER(2002, "提交参数提案(创建提案)"), PROPOSAL_CANCEL(2005, "提交取消提案"), PROPOSAL_VOTE(2003, "给提案投票(提案投票)"),
        VERSION_DECLARE(2004, "版本声明"), REPORT(3000, "举报多签(举报验证人)"), RESTRICTING_CREATE(4000, "创建锁仓计划(创建锁仓)"),
