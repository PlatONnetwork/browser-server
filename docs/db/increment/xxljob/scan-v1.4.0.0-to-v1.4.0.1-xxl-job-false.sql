...
DELETE FROM `xxl_job_info` WHERE  executor_handler = 'updateAddressTransferTxQtyJobHandler';
...
delete from xxl_job_info where job_group = 2 and executor_handler = 'addressUpdateJobHandler';
