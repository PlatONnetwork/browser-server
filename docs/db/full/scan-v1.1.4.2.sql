-- 全量脚本
CREATE
DATABASE IF NOT EXISTS `scan_platon` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE
`scan_platon`;
...
(
    ...
    `type`                  int(11) NOT NULL COMMENT '地址类型 :1账号,2内置合约,3EVM合约,4WASM合约,5Erc20,6Erc721 7 ERC1155',
