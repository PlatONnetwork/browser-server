...
(
    ...
    `type`                          varchar(64) NOT NULL COMMENT '合约类型 erc20 erc721 erc1155',
...
(
    ...
    PRIMARY KEY (`token_address`, `address`, token_id)
);
...
(
    ...
    `token_address`      varchar(64)  NOT NULL COMMENT '合约地址',
    `token_id`           varchar(128) NOT NULL COMMENT 'token id',
#     `balance`            varchar(128)          DEFAULT NULL COMMENT '地址代币余额,ERC1155为token的数量',
#     `owner`              varchar(64)  NOT NULL COMMENT 'token id 对应持有者地址',
    `name`               varchar(256)          DEFAULT NULL COMMENT 'Identifies the asset to which this NFT represents',
    `description`        longtext COMMENT 'Describes the asset to which this NFT represents',
    `image`              varchar(256)          DEFAULT NULL COMMENT 'A URI pointing to a resource with mime type image/* representing the asset to which this NFT represents. Consider making any images at a width between 320 and 1080 pixels and aspect ratio between 1.91:1 and 4:5 inclusive.',
    ...
    `update_time`        timestamp    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    `token_tx_qty`       int(11)      NOT NULL DEFAULT '0' COMMENT 'tokenaddress和tokenid的对应交易数',
#     `token_owner_tx_qty` int(11)               DEFAULT '0' COMMENT 'owner对该tokenaddress和tokenid的对应交易数,每个owenr的信息放在',
    `small_image`        varchar(256)          DEFAULT NULL COMMENT '缩略图',
    `medium_image`       varchar(256)          DEFAULT NULL COMMENT '中等缩略图',
    `token_url`          longtext COMMENT 'url',
    `retry_num`          int(10)      NOT NULL DEFAULT '0' COMMENT '重试次数',
...
INSERT INTO `point_log`(`id`, `type`, `name`, `desc`, `position`, `create_time`, `update_time`)
VALUES (7, 1, 'token_inventory', '增量更新token721库存信息断点记录', '0', '2021-12-10 02:44:32', '2021-12-10 02:44:32');
INSERT INTO `point_log`(`id`, `type`, `name`, `desc`, `position`, `create_time`, `update_time`)
VALUES (8, 1, 'token_inventory', '增量更新销毁token721库存信息断点记录', '0', '2021-12-10 02:44:32', '2021-12-10 02:44:32');


INSERT INTO `point_log`(`id`, `type`, `name`, `desc`, `position`, `create_time`, `update_time`)
VALUES (9, 1, 'tx_1155_bak', '从erc1155交易备份表统计地址表和token表交易数的断点记录', '0', '2021-12-06 02:47:41', '2021-12-06 02:47:41');

INSERT INTO `point_log`(`id`, `type`, `name`, `desc`, `position`, `create_time`, `update_time`)
VALUES (10, 1, 'tx_1155_bak', '从erc1155交易备份表统计TokenHolder持有者数的断点记录', '0', '2021-12-06 10:25:34', '2021-12-06 10:25:39');

INSERT INTO `point_log`(`id`, `type`, `name`, `desc`, `position`, `create_time`, `update_time`)
VALUES (11, 1, 'token_1155_inventory', '增量更新token1155库存信息断点记录', '0', '2021-12-10 02:44:32', '2021-12-10 02:44:32');
INSERT INTO `point_log`(`id`, `type`, `name`, `desc`, `position`, `create_time`, `update_time`)
VALUES (12, 1, 'token_1155_inventory', '增量更新销毁token1155库存信息断点记录', '0', '2021-12-10 02:44:32', '2021-12-10 02:44:32');

update token_expand
set `is_show_in_aton_admin` = 1
where `is_show_in_aton` = 1;
update token_expand
set `is_show_in_scan_admin` = 1
where `is_show_in_scan` = 1;
