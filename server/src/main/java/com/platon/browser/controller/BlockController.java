...
public class BlockController  {
    ...
    /**
     @api {post} block/ticketList a.区块选票列表
     @apiVersion 1.0.0
     @apiName ticketList
     @apiGroup block
     @apiDescription 区块选票列表
     ...
     "txHash": "15566",//交易HASH
     "candidateId": 18080899999,//候选人Id（节点Id）
     ...
     "actualExpireTime": "" //实际过期时间
     }
     ]
     }
     */
    @PostMapping("ticketList")
    public RespPage<Ticket> ticketList (@Valid @RequestBody BlockTicketPageReq req) {
        return blockService.getBlockTicketList(req);
    }


    /**
     @api {post} block/transactionList a.区块交易列表
     @apiVersion 1.0.0
