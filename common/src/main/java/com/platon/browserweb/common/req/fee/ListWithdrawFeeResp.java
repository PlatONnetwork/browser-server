...
public class ListWithdrawFeeResp extends Dto{
	   /**
	 * 
	 */
	private static final long serialVersionUID = -4181399868702868888L;
	...
	public String toString() {
		return "ListBrokerWithdrawFeeResp [id=" + id + ", currency=" + currency + ", brokerFee=" + brokerFee
				+ ", investorFee=" + investorFee + ", effectiveTime=" + effectiveTime
				+ ", endTime=" + endTime + ", setTime=" + setTime + ", juserId=" + juserId + ", juserName=" + juserName
				+ "]";
	}
