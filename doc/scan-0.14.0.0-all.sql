...
CREATE TABLE `node` (
  ...
  `is_consensus` int(11) NOT NULL DEFAULT '2' COMMENT '是否共识周期验证人\r\n:1是\r\n,2否',
  `is_settle` int(11) NOT NULL DEFAULT '2' COMMENT '是否结算周期验证人:\r\n1是\r\n,2否',
  `is_init` int(11) NOT NULL DEFAULT '2' COMMENT '是否为链初始化时内置的候选人\r\n:1是\r\n,2否',
...
CREATE TABLE `proposal` (
  ...
  `status` int(11) NOT NULL DEFAULT '1' COMMENT '提案状态:\r\n1投票中\r\n,2通过,\r\n3失败,\r\n4预升级,5生效\r\n,6被取消',
...
CREATE TABLE `slash` (
  ...
  `is_quit` int(11) NOT NULL DEFAULT '1' COMMENT '是否退出:\r\n1是,\r\n2否',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`hash`),
  KEY `node_id` (`node_id`) USING BTREE
