...
public class StakingNode extends StakingKey {
    ...
    public void setNodeNodeId(String nodeNodeId) {
        this.nodeNodeId = nodeNodeId == null ? null : nodeNodeId.trim();
    }
    ...
    public Integer getNodeStatVerifierTime() {
        return nodeStatVerifierTime;
    }

    public void setNodeStatVerifierTime(Integer nodeStatVerifierTime) {
        this.nodeStatVerifierTime = nodeStatVerifierTime;
    }
	...
	public Integer getAllDelegateQty() {
		return allDelegateQty;
	}

	public void setAllDelegateQty(Integer allDelegateQty) {
		this.allDelegateQty = allDelegateQty;
	}
    ...
    public enum Column {
        ...
        nodeNodeId("node_node_id", "nodeNodeId", "VARCHAR", false),
        ...
        nodeStatVerifierTime("node_stat_verifier_time", "nodeStatVerifierTime", "INTEGER", false),
        isRecommend("is_recommend", "isRecommend", "INTEGER", false),
        nodeCreateTime("node_create_time", "nodeCreateTime", "TIMESTAMP", false),
        nodeUpdateTime("node_update_time", "nodeUpdateTime", "TIMESTAMP", false);
