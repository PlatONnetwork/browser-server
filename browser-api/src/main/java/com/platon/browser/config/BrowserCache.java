...
public class BrowserCache {
	...
	private static ConcurrentHashMap<String,  Session> webSocketSet = new ConcurrentHashMap<String,  Session>();// 与某个客户端的连接会话，需要通过它来给客户端发送数据
	private static ConcurrentHashMap<String, List<String>> keys = new ConcurrentHashMap<>();// 根据分页数的key的存储 value 为用户列表
	...
	public static ConcurrentHashMap<String, List<String>> getKeys() {
		return keys;
	}

	public static void setKeys(ConcurrentHashMap<String, List<String>> keys) {
