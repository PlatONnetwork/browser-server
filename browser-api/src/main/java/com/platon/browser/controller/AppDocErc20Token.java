...
public interface AppDocErc20Token {
     ...
     * }
     */
	@ApiOperation(value = "address/details", nickname = "address details",
			notes = "", response = QueryDetailResp.class, tags = { "Address" })
	@PostMapping(value = "address/details", produces = { "application/json" })
	WebAsyncTask<BaseResp<QueryDetailResp>> details(@ApiParam(value = "QueryDetailRequest ", required = true)
													@Valid @RequestBody QueryDetailRequest req);
