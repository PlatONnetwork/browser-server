 ...
 */
public class Arc20Contract extends Contract {
    ...
    protected Arc20Contract(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider, Long chainId) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider, chainId);
    }

    protected Arc20Contract(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider, Long chainId) {
        super(BINARY, contractAddress, web3j, transactionManager, contractGasProvider, chainId);
    }

    public static RemoteCall<Arc20Contract> deploy(Web3j web3j, Credentials credentials, GasProvider contractGasProvider, Long chainId, BigInteger _supply, String _symbol, BigInteger _decimals, String _name, String _rewardValueAddr) {
        ...
        return deployRemoteCall(Arc20Contract.class, web3j, credentials, contractGasProvider, BINARY, encodedConstructor, chainId);
    }

    public static RemoteCall<Arc20Contract> deploy(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider, Long chainId, BigInteger _supply, String _symbol, BigInteger _decimals, String _name, String _rewardValueAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Uint256(_supply),
                new Utf8String(_symbol),
                new Uint8(_decimals),
                new Utf8String(_name),
                new Address(_rewardValueAddr)));
        return deployRemoteCall(Arc20Contract.class, web3j, transactionManager, contractGasProvider, BINARY, encodedConstructor, chainId);
    }
    ...
    public Observable<LogRegisterEventResponse> logRegisterEventObservable(PlatonFilter filter) {
        return web3j.platonLogObservable(filter).map(new Func1<Log, LogRegisterEventResponse>() {
            @Override
            public LogRegisterEventResponse call(Log log) {
    ...
    public Observable<LogWithdrawalEventResponse> logWithdrawalEventObservable(PlatonFilter filter) {
        return web3j.platonLogObservable(filter).map(new Func1<Log, LogWithdrawalEventResponse>() {
            @Override
    ...
    public RemoteCall<String> rewardValueAddr() {
        final Function function = new Function(FUNC_REWARDVALUEADDR, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }
    ...
    public RemoteCall<Boolean> transferClosed() {
        final Function function = new Function(FUNC_TRANSFERCLOSED, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
        return executeRemoteCallSingleValueReturn(function, Boolean.class);
    }
    ...
    public static Arc20Contract load(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider, Long chainId) {
        return new Arc20Contract(contractAddress, web3j, credentials, contractGasProvider, chainId);
    }

    public static Arc20Contract load(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider, Long chainId) {
        return new Arc20Contract(contractAddress, web3j, transactionManager, contractGasProvider, chainId);
    }
