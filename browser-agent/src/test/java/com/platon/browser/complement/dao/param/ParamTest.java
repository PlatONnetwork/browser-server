//package com.platon.browser.complement.dao.param;//package com.platon.browser.param;
//
...
//public class ParamTest extends AgentTestBase {
//
...
//            if(clazz.getSimpleName().contains("BusinessParam")
//                    ||clazz.getSimpleName().contains("YesNoEnum")
//            ||clazz.getSimpleName().contains("Builder")) continue;
