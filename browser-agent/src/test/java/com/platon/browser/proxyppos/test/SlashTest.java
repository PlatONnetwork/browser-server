...
public class SlashTest extends TestBase {
    private String targetContractAddress = NetworkParameters.getPposContractAddressOfSlash(chainId);
    ...
    public void plan() throws Exception {
        ...
        invokeProxyContract(encode(DuplicateSignType.PREPARE_BLOCK,evidence),targetContractAddress,encode(DuplicateSignType.PREPARE_BLOCK,evidence),targetContractAddress);
    }
}
