...
public class UnDelegateHandlerTest extends TestBase {
    ...
    @Before
    public void setup() {
        ReflectionTestUtils.setField(unDelegateHandler, "cacheHolder", cacheHolder);
    }
    ...
    public void testHandler () throws NoSuchBeanException, CacheConstructException {
        ...
        unDelegateHandler.handle(context);

        verify(unDelegateHandler, times(1)).handle(any(EventContext.class));
    }
}
