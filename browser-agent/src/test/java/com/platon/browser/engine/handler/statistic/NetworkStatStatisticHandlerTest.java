...
public class NetworkStatStatisticHandlerTest extends TestBase {
    ...
    @Before
    public void setup() {
        ReflectionTestUtils.setField(networkStatStatisticHandler, "cacheHolder", cacheHolder);
    }
    ...
    public void testHandler () throws CacheConstructException {
        ...
        verify(networkStatStatisticHandler, times(1)).handle(any(EventContext.class));
    }
}
