...
public class EpochMessage {
    ...
    private List<String> preValidators=new ArrayList<>(); // 前一共识周期验证人列表
    private List<String> curValidators=new ArrayList<>(); // 当前共识周期验证人列表
    private List<String> preVerifiers=new ArrayList<>(); // 前一结算周期验证人列表
    private List<String> curVerifiers=new ArrayList<>(); // 当前结算周期验证人列表
