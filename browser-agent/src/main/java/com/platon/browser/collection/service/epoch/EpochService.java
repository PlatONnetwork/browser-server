...
public class EpochService {
    ...
    @Getter private EpochRetryService.EpochContext epochContext;
    ...
    public void update(BigInteger blockNumber) throws BlockNumberException {
        ...
        if(oldConsensusEpochRound.compareTo(this.consensusEpochRound)!=0){
            ...
            // 共识周期变更
            try {
                epochRetryService.consensusEpochChange(blockNumber);
            } catch (Exception e) {
            ...
            if(oldSettleEpochRound.compareTo(this.settleEpochRound)!=0){
                ...
                // 结算周期变更
                try {
                    epochRetryService.settlementEpochChange(blockNumber);
                } catch (Exception e) {
        ...
        if(oldIssueEpochRound.compareTo(this.issueEpochRound)!=0){
            try {
                epochContext = epochRetryService.issueEpochChange(blockNumber);
            } catch (Exception e) {
