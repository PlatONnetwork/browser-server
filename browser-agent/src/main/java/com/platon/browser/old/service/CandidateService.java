package com.platon.browser.old.service;
...
public class CandidateService {
    ...
    public CandidateResult getVerifiers(Long blockNumber) throws CandidateException, BlockNumberException {
        ...
        while (true) try {
            ...
            String msg = JSON.toJSONString(cr.cur, true);
            ...
            try {
                ...
                String msg = JSON.toJSONString(cr.cur, true);
                logger.debug("下一轮结算周期验证人(实时):{}", msg);
                break;
            } catch (Exception e1) {
    ...
    public InitParam getInitParam() throws InterruptedException {
        ...
        try {
            ...
            String msg = JSON.toJSONString(validators, true);
            logger.debug("共识周期(未块:{})验证人:{}", BigInteger.ZERO, msg);
        } catch (Exception e) {
        ...
        try {
            ...
            String msg = JSON.toJSONString(verifiers,true);
            logger.debug("结算周期(未块:{})验证人:{}",BigInteger.ZERO, msg);
        }catch (Exception e){
